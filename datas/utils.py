...
def create_datasets(args):
    div2k = DIV2K(
        ...
        os.path.join(args.data_path, 'DIV2K'), 
        os.path.join(args.data_path, 'DIV2K/div2k_cache'),
        train=True, 
    ...
    if 'Set5' in args.eval_sets:
        set5_hr_path = os.path.join(args.data_path, 'val/Set5/HR')
        set5_lr_path = os.path.join(args.data_path, 'val/Set5/X{}'.format(args.scale))
    ...
    if 'Set14' in args.eval_sets:
        set14_hr_path = os.path.join(args.data_path, 'val/Set14/HR')
        set14_lr_path = os.path.join(args.data_path, 'val/Set14/X{}'.format(args.scale))
    ...
    if 'B100' in args.eval_sets:
        b100_hr_path = os.path.join(args.data_path, 'val/BSD100/HR')
        b100_lr_path = os.path.join(args.data_path, 'val/BSD100/X{}'.format(args.scale))
    ...
    if 'Urban100' in args.eval_sets:
        u100_hr_path = os.path.join(args.data_path, 'Urban100/HR')
        u100_lr_path = os.path.join(args.data_path, 'Urban100/X{}'.format(args.scale))
    ...
    if 'Manga109' in args.eval_sets:
        manga_hr_path = os.path.join(args.data_path, 'val/MANGA109/HR')
        manga_lr_path = os.path.join(args.data_path, 'val/MANGA109/X{}'.format(args.scale))
